...
class App extends React.Component {
  ...
  render() {
    const { revealModal, show } = this.state;
    return (
      <div>
        <Donate show={revealModal} />
          ...
          >
            ...
            <div className="menulist">
              <Menu
                ...
                className="menu-navs"
              >
                <Menu.Item key="1"><div onClick={() => scroll.scrollToTop()} role="presentation">Home</div></Menu.Item>
                <Menu.Item key="2"><div onClick={() => scroll.scrollTo(400)} role="presentation">About</div></Menu.Item>
                <Menu.Item key="3">Ministries</Menu.Item>
                <Menu.Item key="4"><div onClick={() => scroll.scrollTo(950)} role="presentation"> Give</div></Menu.Item>
                <Menu.Item key="5"><div onClick={() => scroll.scrollTo(1520)} role="presentation">Contact Us</div></Menu.Item>
          ...
          >
            <div className="head-slide slide1">
              <div className="hero1">
                <Fade left>
                  <h1>
                    <ReactRevealText show={show}>Welcome to Paul Hagiazo Ministries</ReactRevealText>
                  </h1>
                </Fade>
              </div>
              ...
              <div className="hero2">
                <Fade right>
                  <p>
                    ...
                    Word became flesh
                    <FontAwesomeIcon icon="quote-right" style={{ marginRight: 5 }} />
                  </p>
                </Fade>
              </div>
            ...
            <div className="head-slde slide1">
              <img src={unsplash5} alt="unpsplash2" style={{ width: '100%', height: 450 }} />
            </div>
          </Carousel>
            ...
            <div style={{ background: '#147BD1', padding: 24, minHeight: 100 }}>
              <Row type="flex" justify="center">
                ...
                <Col span={6} className="periscope-badge">
                  <a
                    href="https://www.pscp.tv/PaulHagiazo"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ textDecoration: 'none' }}
                  >
